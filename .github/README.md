...
### Customizations
Currently, the only customization available is a full screen scoreboard. To enable it, go to `flawhud\resource\ui\#customizations` and create a new folder called `_enabled` and move `scoreboard-full.res` into that folder.
